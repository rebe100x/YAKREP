...
$records[] = array(
	...
	"defaultPlaceLocation" => array('lat'=>43.464881,'lng'=>6.240234),
...
$records[] = array(
	...
	"yakCatId"=>array("504d89c5fa9a957004000000"),
 	"persistDays" => 1,
	"defaultPlaceId" => new MongoId('510a42351d22b31e6801c7f4'), 
	"defaultPlaceLocation" => array('lat'=>43.107465,'lng'=>6.1314928),
	"defaultPlaceSearchName" => "Var, Provence-Alpes-Côte-d'Azur",
	"yakType" => 1, // actu
	"feedType" => "RSS",
	"defaultPrintFlag" => 0,
...
$records[] = array(
	...
	"yakCatId"=>array("504d89c5fa9a957004000000"),
 	"persistDays" => 1,
	"defaultPlaceId" => new MongoId('510a42341d22b31e6801c7c1'), 
	"defaultPlaceLocation" => array('lat'=>43.5410942,'lng'=>6.4647315),
	"defaultPlaceSearchName" => "Var, Provence-Alpes-Côte-d'Azur",
	"yakType" => 1, // actu
	"feedType" => "RSS",
	"defaultPrintFlag" => 0,
...
$records[] = array(
	...
	"yakCatId"=>array("504d89c5fa9a957004000000"),
 	"persistDays" => 1,
	"defaultPlaceId" => new MongoId('510a42331d22b31e6801c77c'), 
	"defaultPlaceLocation" => array('lat'=>43.4062697,'lng'=>6.061752),
	"defaultPlaceSearchName" => "Var, Provence-Alpes-Côte-d'Azur",
	"yakType" => 1, // actu
	"feedType" => "RSS",
	"defaultPrintFlag" => 0,
...
$records[] = array(
	...
	"yakCatId"=>array("504d89c5fa9a957004000000"),
 	"persistDays" => 1,
	"defaultPlaceId" => new MongoId('510a42341d22b31e6801c7e2'), 
	"defaultPlaceLocation" => array('lat'=>43.4324683,'lng'=>6.7351796),
	"defaultPlaceSearchName" => "Var, Provence-Alpes-Côte-d'Azur",
	"yakType" => 1, // actu
	"feedType" => "RSS",
	"defaultPrintFlag" => 0,
...
$records[] = array(
	"_id" => new MongoId("5146ecddfa9a956c0e000001"),
	"XLconnector"=>"parser",
	"humanName"=>"ABC",	
	"name"=>"ABC",
	"linkSource"=>array("elo"),
	"link"=>"http://opendata.regionpaca.fr/donnees/detail/signataires-de-la-charte-esprit-client-de-la-ccimp.html",
	"fileSource"=>array("./input/CCIMP-A-CLIENTS-01-2013.csv"),
	"rootElement"=>"",
	"lineToBegin"=>"3",
	"parsingTemplate"=>array(
	...
	"licence"=>"Open",
	"yakcat"=>array(
					array("name"=>"Commerce","_id"=>"50f025f7fa9a957c0c000048"),
					array("name"=>"Sport","_id"=>"506479f54a53042191000000"),
				),
	//"yakCatNameArray" => array('Commerce'),
	//"yakCatId"=>array("50f025f7fa9a957c0c000048"),
	"tag"=>array('Restau','Pétanque	'),
 	"persistDays" => 365,
	"defaultPlaceId" => new MongoId('50eefc29fa9a953c0a00001d'), //PACA
	"defaultPlaceLocation" => array('lat'=>43.935175,'lng'=>6.067918),
	"defaultPlaceSearchName" => "Provence-Alpes-Côte-d'Azur",
...
$records[] = array(
	...
	"fileSource"=>array("./input/hotels-bouches-du-rhone.csv"),
	"rootElement"=>"",
	"lineToBegin"=>"1",
	"parsingTemplate"=>array(
						'title' => "#YKL0",
...
$records[] = array(
	...
	"fileSource"=>array("./input/restaurants-gastronomiques-bouches-du-rhone.csv"),
	"rootElement"=>"",
	"lineToBegin"=>"1",
	"parsingTemplate"=>array(
						'title' => "#YKL0",
...
$records[] = array(
	...
	"fileSource"=>array("./input/restaurants-bouches-du-rhone.csv"),
	"rootElement"=>"",
	"lineToBegin"=>"1",
	"parsingTemplate"=>array(
						'title' => "#YKL0",
...
$records[] = array(
	...
	"fileSource"=>array("./input/locationdevelo.csv"),
	"rootElement"=>"",
	"lineToBegin"=>"1",
	"parsingTemplate"=>array(
						'title' => "#YKL0",
...
$records[] = array(
	...
	"linkSource"=>array(""),
	"fileSource"=>array("./input/ouestfrance_small.xml"),
	"link"=>"infolocale.fr",
...
$records[] = array(
	...
	"linkSource"=>array("http://api.meteorologic.net/forecarss?p=Marseille&cn=France"),
	"link"=>"http://www.meteorologic.net/meteo-france/Marseille_4330.html",
	"fileSource"=>array(""),
	"rootElement"=>"/rss/channel/item",
	"lineToBegin"=>"0",
	"parsingTemplate"=>array(
						'title' => "Météo: #YKLtitle - #YKLcurrent_french_date",
						'content' => "#YKLdescription",
...
$records[] = array(
	...
	"yakCatId"=>array(new MongoId("504d89c5fa9a957004000000")),
	"persistDays" => 1,
	"defaultPlaceId" => new MongoId("510a3b171d22b31e68003c9a"),
	"defaultPlaceSearchName" => "13100, Bouches-du-Rhône",
	"yakType" => 1,
	"feedType" => "RSS",
	"defaultPrintFlag" => 0,
	"creationDate" => new MongoDate(gmmktime()),
...
$records[] = array(
	...
	"defaultPlaceSearchName" => "",
	"yakType" => 1,
	"defaultPrintFlag" => 3,// if not geolocalized, we localize at the default location but we don't print on the map ( only in the text feed )
	"creationDate" => new MongoDate(gmmktime()),
	"status" => 1,
	"daysBack" => 5,
	"zone" =>1,
